...
- Create Angular project with ng: `ng new coworkingproject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`coworkingproject.client.esproj`).
